...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--lr', type=float, default=0.01, metavar='LR', help='learning rate (default: 0.01)')
    ...
    subparsers.add_argument('--size', default=20, type=int, help='prompt pool size')
    subparsers.add_argument('--length', default=5,type=int, help='prompt length')
    subparsers.add_argument('--top_k', default=5, type=int, help='top k prompts selected')
